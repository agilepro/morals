...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\linewidth,keepaspectratio]{{../docs/Morality/divine-command}.png}
\end{figure}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\linewidth,keepaspectratio]{{../docs/Morality/bible}.png}
\end{figure}
