% Generated from christian-morality.md - do not edit.

\chapter{Biblical Morality}
...
\section{Moral Foundation Needed}%
\index{moral!foundation}\nobreak%
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\linewidth,keepaspectratio]{{../markua/divine-command}.png}
\end{figure}
...
\section{Knowability of God's Truths}%
\index{knowing god}\nobreak%

The bible itself is inconsistent about moral advice.

\begin{itemize}
\item Slavery, now regarded as evil, was accepted by the writers of the bible as normal behavior
\item Food illnesses caused various taboos that are no longer relevant since germ theory was discovered
\item Practices around dealing with leprosy and other diseases were often harmful
\item The old testament is filled with stories of holy genocide.  The early tribes of Israel were in fact warring tribes, and the myths of a bible are clearly meant to motivate the population to do the will of the warlord.  How can the destruction of the Amalekites possibly be considered moral?
\end{itemize}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\linewidth,keepaspectratio]{{../markua/bible}.png}
\end{figure}
...
\section{Righteous Arrogance}%
\index{righteous arrogance}\nobreak%
...
\section{Lawgiver is Unnecessary}%
\index{lawgiver}\nobreak%
...
\section{What Christians Say about Others}

\begin{quote}
``In a world without God, there can be no objective right and wrong, only our culturally and personally relative, subjective judgments. This means that it is impossible to condemn war, oppression, or crime as evil. Nor can one praise brotherhood, equality, and love as good. For in a universe without God, good and evil do not exist---there is only the bare valueless fact of existence, and there is no one to say you are right and I am wrong.''\index{Craig, William Lane}
--- William Lane Craig, \href{https://www.reasonablefaith.org/writings/popular-writings/existence-nature-of-god/the-absurdity-of-life-without-god/}{`The Absurdity of Life without God', TheHuffingtonPost.com, 18 Dec 2013}
\end{quote}

Even without God, we can appeal to something outside of our `culturally and personally relative, subjective judgments'.

\begin{quote}
``. . . this indignation is perfectly groundless if we ourselves regard morality as a subjective sentiment to be altered at will. Unless there is some objective standard of good, overarching Germans, Japanese, and ourselves alike whether any of us obey it or no, then of course the Germans are as competent to create their ideology as we are to create ours.''\index{Lewis, C. S.}
...
Frank Turek said:  ``the only reason I know what was good is because there's a standard of good outside myself, and that's God's nature.''\index{Turek, Frank}
...
Take for example marriage. Most Christians will insist that a proper moral marriage is one man and one woman. But King David is a very important person in the Old Testament, and he had 13 wives. Ask the Christian if King David was a moral person, or if his Marriages were moral. An honest Christian will say no. One must than wonder why the Bible spends so much time telling a story about such an immoral person. \index{King David}
