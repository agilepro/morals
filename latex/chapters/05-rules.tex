...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\linewidth,keepaspectratio]{{../docs/Morality/kick-out}.png}
\end{figure}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\linewidth,keepaspectratio]{{../docs/Morality/rule-web}.png}
\end{figure}
...
\textbf{Classification}: Rules talk about a set of actions which are categorized in a certain way.  For example:
