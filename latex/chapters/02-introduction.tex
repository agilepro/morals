...
\leavevmode\index{eudaimonia}%
Ancient philosophers debated ethics and morality, which is the topic of how to live the \emph{right life} (also called the \emph{good life} or \emph{eudaimonia}). It is a question that was probably first asked at the time mankind first began to talk.
