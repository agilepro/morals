...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\linewidth,keepaspectratio]{{../markua/boat-coracle}.png}
\end{figure}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\linewidth,keepaspectratio]{{../markua/boat-racing}.png}
\end{figure}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\linewidth,keepaspectratio]{{../markua/dog-morality}.png}
\end{figure}
