% Generated from objective-truths.md - do not edit.

\chapter{Objective Truths}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\linewidth,keepaspectratio]{{../docs/Morality/boat-coracle}.png}
\end{figure}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\linewidth,keepaspectratio]{{../docs/Morality/boat-racing}.png}
\end{figure}
...
\section{Dog Morality}

\leavevmode\index{murder}\index{property rights}%
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\linewidth,keepaspectratio]{{../docs/Morality/dog-morality}.png}
\end{figure}
