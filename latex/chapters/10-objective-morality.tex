% Generated from objective-morality.md - do not edit.

\chapter{Objective Morality}

\leavevmode\index{moral realism}%
Objective morality (also known as Moral Objectivism or Moral Realism) is \emph{the philosophical belief that moral principles and values are universally true and exist independently of human opinion, cultural norms, or personal feelings.}
...
\begin{itemize}
\item Morality is defined as the way to live a good life.
\item Humans depend on each other to survive, so the good life is a good life in the community, and must be good for the community as well.
\item Morality is then the best way to live and work together.
\item Morality is not simplistic rules, but take into account and may apply differently to different contexts.
\item Actions we take have objective consequences that affect others.
\end{itemize}
...
\leavevmode\index{property rights}%
...
\section{Existing Is Not Knowing}
...
\section{Good Morals Survive With The Tribe That Exhibits Them}%
\index{tribe}\nobreak%
...
\section{Goodness Is Equated With Existence}

\emph{Sure, a particular action may be optimized to bring the best consequence to the most people, but does that make it morally good?}
